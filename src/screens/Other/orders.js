        ...
        return (
            <View style={{ flex: 1, padding: p(12) }}>
                ...
                <View style={styles.header}>
                    <Text style={[styles.text, { color: COLORS.light_color }]}>Orders</Text>
                </View>

                <View style={{ flexDirection: 'row', paddingVertical: p(12), alignItems: 'center' }}>
                    <Image source={{ uri: 'https://i.pinimg.com/236x/db/14/3c/db143c27468a1e64bab6d1480f5e4b59.jpg' }} style={styles.avatar} />
                    <Text style={styles.title}>Sarah Doe</Text>
                </View>
                ...
                <View style={{ flex: 1, justifyContent: 'flex-end' }}>
                    ...
                    <TouchableOpacity style={[styles.btn, { backgroundColor: COLORS.red_color}]}>
